...
% ------------------------------------------------------------------------------  
  ...
  statiques ou dynamiques. Il exite depuis 1999, donc bien avant la Kinect.
...
% ------------------------------------------------------------------------------  
  ...
  prédiction et
  d'interpolation à fin d'avoir une squelette répondant à des constraintes 
  physiques à 60Hz. La plupart des jeux moderne tournent à cette vitesse, et 
  rapellons nous que la caméra ne fournit que des données 30Hz
