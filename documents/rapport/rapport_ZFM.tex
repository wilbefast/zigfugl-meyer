...
couleur, un microphone et un système senseur de profondeur composé d'un 
projecteur infra-rouge et d'un capteur. 

L'appareil est donc capable de générer une image 3D d'une scène par 
temps de vol. Cette image a une résolution de 640x480 et une profondeur de 11 
bits, est mis à jour 30 fois par seconde.
...
Cela amène au regret que le test standard soit un test jugeant la \textbf{déficience} et non \textbf{fonctionnalité}. Il existe cependant de nombreux autres tests, et une des alternatives intéressante est le test "ARAT : Action Research Arm Test". %TODO réf lien
