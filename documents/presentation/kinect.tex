...
\begin{center}
\only<1>{\includegraphics[width=0.9\linewidth]{../images/technology_overview_1}}
\only<2>{\includegraphics[width=0.9\linewidth]{../images/technology_overview_2}}
\only<3>{\includegraphics[width=0.9\linewidth]{../images/technology_overview_3}}
\end{center}
