...
public class ZigDepthViewer : MonoBehaviour
{
	...
	void Start()
	{
		...
		// 'gameObject' refers to this component's container
	...
	void OnGUI()
	{
		...
		if(target == null)
		{
			GUI.DrawTexture(new Rect(Screen.width - texture.width - 10, 
																Screen.height - texture.height - 10, 
